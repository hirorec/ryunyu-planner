...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-50 flex w-full max-w-mobile -translate-x-1/2 items-stretch border-t border-brand-bg bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
