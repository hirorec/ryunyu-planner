...
> = {
  ok:      { label: '✓ 済み',   bg: 'bg-status-ok',   fg: 'text-status-ok-fg',   border: 'border-green-300' },
  skip:    { label: '△ 様子見', bg: 'bg-status-skip', fg: 'text-status-skip-fg', border: 'border-yellow-300' },
  ng:      { label: '✕ NG',    bg: 'bg-status-ng',   fg: 'text-status-ng-fg',   border: 'border-red-300' },
  untried: { label: '未',       bg: 'bg-gray-100',    fg: 'text-gray-400',       border: 'border-gray-200' },
}
